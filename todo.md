...
4. after compiling and running the output should be returned to the page
5. create an html file that can post to the backend
6. create a javascript file that can get from the backend
7. get the system out and system err from the file that was created from the earlier stuff